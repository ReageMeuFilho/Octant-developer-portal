# Octant v2 Developer Portal - Project TODO
...
## Phase 2: Tier 1 - Marketing Landing Page
- [x] Hero section with headline and CTA buttons
- [x] Trust badges and credibility indicators
- [ ] Animated flow diagram (Treasury → Vault → DeFi → Yield → Projects)
- [x] Featured use cases cards (4 developer stories)
- [x] Key benefits section (Capital Preservation, Composability, Sustainability)
- [ ] Social proof section (testimonials, case studies)
- [ ] Technical highlights section
- [x] Footer with navigation links

## Phase 3: Tier 2 - Documentation Hub
- [ ] Documentation homepage with clear navigation
- [ ] Search functionality
- [ ] Sidebar navigation with collapsible sections
- [ ] Breadcrumb navigation

## Phase 4: Quickstart Guides
- [ ] Beginner Complete Guide (zero Web3 knowledge)
- [ ] Web3 Developer Fast Track
- [ ] Treasury Manager Wizard
- [ ] Integration Partner Guide

## Phase 5: Core Concepts Documentation
- [ ] What is Octant v2
- [ ] How It Works
- [ ] Architecture Overview
- [ ] Glossary

## Phase 6: Developer Paths
- [ ] Yield Donating Strategies guide
- [ ] Yield Skimming Strategies guide
- [ ] Tokenized Allocation Mechanisms guide
- [ ] Multi-Strategy Vaults guide

## Phase 7: Tutorials & Code Examples
- [ ] Strategy Development Tutorial (SavingsUsdcStrategy)
- [ ] Deploy Your First Vault tutorial
- [ ] Integration with Aave tutorial
- [ ] Integration with Lido tutorial
...
## Phase 10: Additional Resources
- [ ] Testnet resources page
- [ ] SDKs and tools page
- [ ] Community resources
- [ ] FAQ section
