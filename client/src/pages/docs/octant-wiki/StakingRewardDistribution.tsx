...
export default function StakingRewardDistribution() {
  ...
  return (
    <DocsLayoutNew>
      ...
      {/* Scene 1: Reward Distribution Overview */}
      ...
      {/* Scene 4: Claim & Compound Operations */}
      <section className="min-h-screen flex flex-col justify-center py-20 bg-muted/30">
        <div className="max-w-5xl mx-auto space-y-12">
          <div className="space-y-6">
            <h1 className="text-5xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
              Claim & Compound Operations
            </h1>
            <h2 className="text-3xl font-semibold text-foreground">
              Reward Distribution
            </h2>
