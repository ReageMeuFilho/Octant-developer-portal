export default function PrerequisitesCheck() {
  return (
    <div className="max-w-4xl">
      <h1 className="text-4xl font-bold mb-6">Prerequisites Check</h1>
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <p className="text-gray-300 mb-6">
          This page will cover essential information about <strong>prerequisites check</strong> in the context
          of building with Octant v2.
        </p>

        <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700 mb-8">
          <h3 className="text-lg font-semibold mb-3">Section: Quick Start</h3>
