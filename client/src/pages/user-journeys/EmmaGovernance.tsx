...
export default function EmmaGovernance() {
  return (
    <DocsLayoutNew>
        ...
        <section className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground">
               Governance Activist:Active protocol governance participation
            </p>
          </div>
          ...
          <Card className="p-6 border-2 border-blue-500">
            <div className="flex items-start gap-6">
              ...
              <div className="space-y-2 flex-1">
                <h2 className="text-2xl font-bold">Emma</h2>
                <p className="text-lg text-muted-foreground"> Governance Activist:Active protocol governance participation</p>
              </div>
            </div>
          </Card>
