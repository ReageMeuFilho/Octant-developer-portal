...
export default function HedgeFundInstitutional() {
  return (
    <DocsLayoutNew>
        ...
        <section className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground">
               Institutional:Professional fund management at scale
            </p>
          </div>
          ...
          <Card className="p-6 border-2 border-blue-500">
            <div className="flex items-start gap-6">
              ...
              <div className="space-y-2 flex-1">
                <h2 className="text-2xl font-bold">Hedge Fund</h2>
                <p className="text-lg text-muted-foreground"> Institutional:Professional fund management at scale</p>
              </div>
            </div>
          </Card>
